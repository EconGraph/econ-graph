...
describe('TrendAnalysisChart', () => {
  ...
  it('renders the trend analysis chart', () => {
    render(<TrendAnalysisChart ratios={mockRatios} companyId="test-company" />);
  ...
  it('shows loading state when data is being processed', () => {
    render(<TrendAnalysisChart ratios={[]} companyId="test-company" />);
  ...
  it('handles ratio selection with no trend data', () => {
    ...
    render(<TrendAnalysisChart ratios={singleRatio} companyId="test-company" />);
