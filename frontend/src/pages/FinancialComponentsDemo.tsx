...
export const FinancialComponentsDemo: React.FC = () => {
  ...
  const [userType, setUserType] = useState<'beginner' | 'intermediate' | 'advanced' | 'expert'>(
    'intermediate'
  );
  ...
  const components = [
    ...
    },
    {
      ...
      component: (
        <PeerComparisonChart ratios={mockRatios} company={mockCompany} userType={userType} />
      ),
    },
    {
      id: 'alerts',
            ...
            <div className='flex items-center space-x-4'>
              <Select
                ...
                onValueChange={(value: string) =>
                  setDeviceType(value as 'mobile' | 'tablet' | 'desktop')
                }
              >
              ...
              <Select
                value={userType}
                onValueChange={(value: string) =>
                  setUserType(value as 'beginner' | 'intermediate' | 'advanced' | 'expert')
                }
              >
                <SelectTrigger className='w-32'>
                  <SelectValue />
        ...
        <div className='grid grid-cols-1 lg:grid-cols-4 gap-8'>
          ...
          <div className='lg:col-span-3'>
            <Card>
              ...
              <CardContent>
                <div className='border rounded-lg bg-white'>{currentComponent?.component}</div>
              </CardContent>
            </Card>
...
/>`}
                  ...
                  <div>
                    ...
                    <ul className='text-sm space-y-1'>
                      ...
                      <li>
                        <code>userType</code> - User experience level (beginner, intermediate,
                        advanced, expert)
                      </li>
                      <li>
                        <code>showEducationalContent</code> - Enable educational features
                      </li>
                      <li>
                        <code>showCollaborativeFeatures</code> - Enable collaboration features
                      </li>
                    </ul>
                  </div>
                </div>
