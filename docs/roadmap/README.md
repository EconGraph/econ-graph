...
| Doc | Verdict | Why |
|---|---|---|
| `docs/business/PRODUCT_SUMMARY_2025.md` | Archive | Auto-generated with bad metrics ("0 lines", "99.9%"). Claims OECD data and real-time features that don't exist |
...
| `ci/docs/CI_FAILURE_ANALYSIS_AND_FIXES.md`, `E2E_TEST_FAILURE_ANALYSIS.md`, `workflow-status-report.md` | Archive | Point-in-time incident notes from September 2025 |
