//! # Database Schema
//!
//! This module contains the auto-generated database schema definitions for the `EconGraph` system.
//! It defines all database tables, relationships, and constraints used throughout the application.
//!
//! ## Features
//!
//! - **Auto-Generated**: Automatically generated by Diesel CLI from database migrations
...
//!     .filter(companies::name.eq("Apple Inc"))
