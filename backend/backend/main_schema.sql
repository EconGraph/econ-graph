...
\restrict 3vPn3KfXWhAlRk2OMcAYzxbosJTJESHZnrHbhzoCgoeBO5NADg7fyPOyCoePlo5
...
COMMENT ON TABLE public.audit_logs IS 'Comprehensive audit trail for all administrative and user actions';


--
-- Name: COLUMN audit_logs.user_name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.audit_logs.user_name IS 'Name of user who performed the action (denormalized for performance)';
...
COMMENT ON COLUMN public.audit_logs.resource_type IS 'Type of resource affected (user, series, chart, etc.)';


--
-- Name: COLUMN audit_logs.resource_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.audit_logs.resource_id IS 'ID of the specific resource affected (nullable for global actions)';
...
CREATE TABLE public.chart_annotations (
    ...
    annotation_value numeric(20,6),
    title character varying(255) NOT NULL,
    description text,
    color character varying(7) DEFAULT '#2196f3'::character varying,
    annotation_type character varying(20) DEFAULT 'line'::character varying,
...
CREATE TABLE public.chart_collaborators (
    ...
    permissions jsonb DEFAULT '{"edit": false, "view": true, "annotate": false}'::jsonb,
    created_at timestamp with time zone DEFAULT now(),
...
CREATE TABLE public.countries (
    ...
    gdp_per_capita_usd numeric(15,2),
...
COMMENT ON TABLE public.countries IS 'Master table of countries with geographic and economic metadata for global analysis';
...
CREATE TABLE public.country_correlations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    country_a_id uuid NOT NULL,
    country_b_id uuid NOT NULL,
    indicator_category character varying(100) NOT NULL,
    ...
    CONSTRAINT country_correlations_check CHECK ((country_a_id <> country_b_id)),
    CONSTRAINT country_correlations_correlation_coefficient_check CHECK (((correlation_coefficient >= '-1.0'::numeric) AND (correlation_coefficient <= 1.0)))
);


--
-- Name: TABLE country_correlations; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.country_correlations IS 'Calculated correlations between countries for various economic indicators';
...
CREATE TABLE public.crawl_attempts (
    ...
    completed_at timestamp with time zone,
    crawl_method character varying(50) NOT NULL,
    crawl_url text,
    http_status_code integer,
    data_found boolean DEFAULT false NOT NULL,
...
--
-- Name: COLUMN data_sources.api_key_name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.data_sources.api_key_name IS 'Name of the environment variable containing the API key for this data source. NULL if no API key is required.';
...
--
-- Name: COLUMN economic_series.first_discovered_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.economic_series.first_discovered_at IS 'When this series was first discovered by our crawler';


--
-- Name: COLUMN economic_series.last_crawled_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.economic_series.last_crawled_at IS 'When we last attempted to crawl this specific series';


--
-- Name: COLUMN economic_series.first_missing_date; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.economic_series.first_missing_date IS 'First date we detected missing data (NULLable - series may still be active)';


--
-- Name: COLUMN economic_series.crawl_status; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.economic_series.crawl_status IS 'Status of last crawl attempt (success, failed, pending, etc.)';


--
-- Name: COLUMN economic_series.crawl_error_message; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.economic_series.crawl_error_message IS 'Error message from last failed crawl attempt';
...
--
-- Name: TABLE event_country_impacts; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.event_country_impacts IS 'Impact of global events on individual countries';
...
--
-- Name: TABLE global_economic_events; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.global_economic_events IS 'Major global economic events and their characteristics';
...
--
-- Name: TABLE global_economic_indicators; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.global_economic_indicators IS 'Economic indicators available for cross-country analysis';
...
--
-- Name: TABLE global_indicator_data; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.global_indicator_data IS 'Time series data for global economic indicators';
...
CREATE TABLE public.leading_indicators (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    leading_country_id uuid NOT NULL,
    following_country_id uuid NOT NULL,
    indicator_category character varying(100) NOT NULL,
    lead_time_months integer NOT NULL,
    correlation_strength numeric(5,4) NOT NULL,
    predictive_accuracy numeric(5,4),
    time_period_start date NOT NULL,
    time_period_end date NOT NULL,
    calculated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT leading_indicators_check CHECK ((leading_country_id <> following_country_id)),
    CONSTRAINT leading_indicators_lead_time_months_check CHECK (((lead_time_months >= 1) AND (lead_time_months <= 24)))
);


--
-- Name: TABLE leading_indicators; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.leading_indicators IS 'Countries that lead others in economic indicators';
...
COMMENT ON TABLE public.security_events IS 'Security-related events and incidents for monitoring and alerting';
...
COMMENT ON COLUMN public.security_events.event_type IS 'Type of security event (login_failure, suspicious_activity, etc.)';
...
COMMENT ON COLUMN public.security_events.metadata IS 'Additional context and technical details about the security event';


--
-- Name: COLUMN security_events.resolved; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.security_events.resolved IS 'Whether the security event has been resolved';
...
CREATE TABLE public.series_metadata (
    ...
    geographic_level character varying(100),
    data_url text,
    api_endpoint text,
...
CREATE TABLE public.trade_relationships (
    ...
    trade_flow_type character varying(20) NOT NULL,
    year integer NOT NULL,
    export_value_usd numeric(20,2),
    import_value_usd numeric(20,2),
    trade_balance_usd numeric(20,2),
    trade_intensity numeric(8,6),
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT trade_relationships_check CHECK ((exporter_country_id <> importer_country_id))
);


--
-- Name: TABLE trade_relationships; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.trade_relationships IS 'Bilateral trade data between countries';
...
--
-- Name: country_correlations country_correlations_country_a_id_country_b_id_indicator_ca_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.country_correlations
    ADD CONSTRAINT country_correlations_country_a_id_country_b_id_indicator_ca_key UNIQUE (country_a_id, country_b_id, indicator_category, time_period_start, time_period_end);
...
--
-- Name: data_points data_points_series_id_date_revision_date_is_original_releas_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.data_points
    ADD CONSTRAINT data_points_series_id_date_revision_date_is_original_releas_key UNIQUE (series_id, date, revision_date, is_original_release);
...
--
-- Name: event_country_impacts event_country_impacts_event_id_country_id_impact_type_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_country_impacts
    ADD CONSTRAINT event_country_impacts_event_id_country_id_impact_type_key UNIQUE (event_id, country_id, impact_type);
...
--
-- Name: global_economic_indicators global_economic_indicators_country_id_indicator_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.global_economic_indicators
    ADD CONSTRAINT global_economic_indicators_country_id_indicator_code_key UNIQUE (country_id, indicator_code);
...
--
-- Name: global_indicator_data global_indicator_data_indicator_id_date_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.global_indicator_data
    ADD CONSTRAINT global_indicator_data_indicator_id_date_key UNIQUE (indicator_id, date);
...
--
-- Name: leading_indicators leading_indicators_leading_country_id_following_country_id__key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.leading_indicators
    ADD CONSTRAINT leading_indicators_leading_country_id_following_country_id__key UNIQUE (leading_country_id, following_country_id, indicator_category);
...
--
-- Name: series_metadata series_metadata_source_id_external_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.series_metadata
    ADD CONSTRAINT series_metadata_source_id_external_id_key UNIQUE (source_id, external_id);
...
ALTER TABLE ONLY public.trade_relationships
    ADD CONSTRAINT trade_relationships_exporter_country_id_importer_country_id_key UNIQUE (exporter_country_id, importer_country_id, trade_flow_type, year);
...
--
-- Name: idx_chart_annotations_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_chart_annotations_series_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_correlations_category; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_correlations_countries; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_correlations_strength; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_countries_income_group; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_countries_iso_codes; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_crawl_attempts_attempted_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_crawl_attempts_data_found; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_crawl_attempts_error_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_crawl_attempts_latest_data_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_crawl_attempts_series_attempted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_crawl_attempts_series_success; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_crawl_attempts_success; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_crawl_attempts_success_attempted; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_data_points_latest_revision; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_data_points_series_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_data_points_series_date_revision; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_impacts_country; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_global_data_date_value; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_global_data_indicator_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_global_indicators_code; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_global_indicators_country_category; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_leading_indicators_strength; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_series_metadata_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_series_metadata_external_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_series_metadata_last_discovered; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_series_metadata_source_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trade_exporter_year; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trade_importer_year; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trade_value; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_data_source_preferences_visible; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: crawl_attempts set_crawl_attempts_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: series_metadata trigger_update_series_metadata_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: global_economic_events update_global_events_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: global_economic_indicators update_global_indicators_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.chart_collaborators
    ADD CONSTRAINT chart_collaborators_invited_by_fkey FOREIGN KEY (invited_by) REFERENCES public.users(id);
...
--
-- Name: country_correlations country_correlations_country_a_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.country_correlations
    ADD CONSTRAINT country_correlations_country_a_id_fkey FOREIGN KEY (country_a_id) REFERENCES public.countries(id) ON DELETE CASCADE;


--
-- Name: country_correlations country_correlations_country_b_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.country_correlations
    ADD CONSTRAINT country_correlations_country_b_id_fkey FOREIGN KEY (country_b_id) REFERENCES public.countries(id) ON DELETE CASCADE;
...
--
-- Name: global_economic_events global_economic_events_primary_country_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.global_economic_events
    ADD CONSTRAINT global_economic_events_primary_country_id_fkey FOREIGN KEY (primary_country_id) REFERENCES public.countries(id);


--
-- Name: global_economic_indicators global_economic_indicators_country_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.global_economic_indicators
    ADD CONSTRAINT global_economic_indicators_country_id_fkey FOREIGN KEY (country_id) REFERENCES public.countries(id) ON DELETE CASCADE;
...
--
-- Name: leading_indicators leading_indicators_following_country_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.leading_indicators
    ADD CONSTRAINT leading_indicators_following_country_id_fkey FOREIGN KEY (following_country_id) REFERENCES public.countries(id) ON DELETE CASCADE;


--
-- Name: leading_indicators leading_indicators_leading_country_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.leading_indicators
    ADD CONSTRAINT leading_indicators_leading_country_id_fkey FOREIGN KEY (leading_country_id) REFERENCES public.countries(id) ON DELETE CASCADE;
...
--
-- Name: series_metadata series_metadata_source_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.series_metadata
    ADD CONSTRAINT series_metadata_source_id_fkey FOREIGN KEY (source_id) REFERENCES public.data_sources(id) ON DELETE CASCADE;
...
\unrestrict 3vPn3KfXWhAlRk2OMcAYzxbosJTJESHZnrHbhzoCgoeBO5NADg7fyPOyCoePlo5
