...
\restrict bQkCAalL0prwhezWeA3a4buoXOdG7cWTeOVfSJFusD2dRg45YlH8Ef5vycJx8Ny
...
CREATE INDEX idx_crawl_queue_priority ON public.crawl_queue USING btree (priority);
...
--
-- Name: idx_global_economic_events_event_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_global_economic_events_event_date ON public.global_economic_events USING btree (event_date);
...
--
-- Name: idx_global_economic_events_impact_level; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_global_economic_events_impact_level ON public.global_economic_events USING btree (impact_level);


--
-- Name: idx_global_economic_events_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_global_economic_events_source ON public.global_economic_events USING btree (source);
...
--
-- Name: crawl_queue crawl_queue_series_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.crawl_queue
    ADD CONSTRAINT crawl_queue_series_id_fkey FOREIGN KEY (series_id) REFERENCES public.economic_series(id) ON DELETE CASCADE;
